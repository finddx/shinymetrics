...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "A package that produces metrics for FIND Shiny applications",
    Description = "A package that produces metrics for FIND Shiny applications",
    `Authors@R` = c(
      person("Anna", "Mantsoki", email = "anna", role = c("aut", "cre"), comment = c(ORCID = "0000-0002-1565-9313")),
      person(given = "FIND", role = "datascientist")
    )
  )
)
